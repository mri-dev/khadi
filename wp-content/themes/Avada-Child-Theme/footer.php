    ...
    <div class="wrapper">
      <div class="grid">
        <div class="contact">
          <div class="grid">
            <div class="logo">
              <img src="<?php echo IMG; ?>/logo-emblem.svg" alt="<?php echo get_option('blogname'); ?>">
            </div>
            <div class="cont-data">
              <h3><?php echo __('Kapcsolat', TD); ?></h3>
              <strong>Presto-Pilot Kft.</strong><br>
        ...
        <div class="ask">
          <div class="grid">
            ...
            <div class="text">
              <?php echo __('Termékről kérdeznél?',TD); ?><br>
